...
public:
    ...
    // function, returning a vector of errors when evaluated at the provided variable value. It
    // must also calculate the Jacobians for this measurement function, if requested.
    Vector evaluateError(const Pose2 &q, const Pose2 &p, boost::optional<Matrix &> H1 = boost::none, boost::optional<Matrix &> H2 = boost::none) const override
    {
        ...
        return (Vector(1) << r2 - mr_).finished();
    }
...
int main(int argc, char** argv) {
  ...
  graph.emplace_shared<RangeOnlyFactor>(1, 2, 2.0, rangeOnlyNoise);
  graph.emplace_shared<RangeOnlyFactor>(2, 3, 2.0, rangeOnlyNoise);
